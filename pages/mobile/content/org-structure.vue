      ...
      <div class="content" ref="content">
        ...
        <div class="middle">
          <div class="left" style="margin-bottom: 37px">
            <div class="left-button box-shadow hover-move" @click="$utils.goLink(config.orgnizationStructure.left[0].link, config.orgnizationStructure.left[0].newPage)">
          ...
          <div class="left">
            <div class="left-button box-shadow hover-move" v-for="(part,index) in config.orgnizationStructure.right" :key="index" @click="$utils.goLink(part.link, part.newPage)">
