  ...
  <div class="org-structure">
    ...
    <div class="content-wrapper">
      <div class="content" ref="content">
        ...
        <div class="middle">
          <div class="left">
            <div class="left-button box-shadow hover-move" style="margin-top:28px;margin-bottom: 43px;" @click="goLink(orgnizationStructure.left[0].link, orgnizationStructure.left[0].newPage)">
          ...
          <div class="right">
            <div class="right-button box-shadow hover-move" v-for="(part,index) in orgnizationStructure.right" :key="index" @click="goLink(part.link, part.newPage)">
              {{part.title}}
            </div>
          </div>
        </div>
        <div class="bottom">
          <div v-for="(part,index) in orgnizationStructure.bottom" class="part" :key="index">
            <div :class="['part-title', 'box-shadow', `part-title-${index}`, 'hover-move']" @click="goLink(part.link, part.newPage)">{{part.title}}</div>
            <div class="child hover-move" v-for="(c,i) in part.children" :key="i" @click="goLink(c.link, c.newPage)">{{c.title}}</div>
          </div>
        </div>
      </div>
    </div>
